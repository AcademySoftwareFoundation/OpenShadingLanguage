...
%{
#define SRCLOC(yyloc) SrcLoc(oslcompiler->srcloc().filename, yyloc.first_line, yyloc.first_column, yyloc.last_line, yyloc.last_column)
        ...
        | '(' compound_expression ')'
                {
                    if ($2->nodetype() == ASTNode::comma_operator_node) {
                        ...
                        oslcompiler->warningfmt(SRCLOC(@1),
