...
set con_cmd=`testshade --batched -g 1024 1024 -t 1 --iters $ITER_NUM --stats -od uint8 -o cv constant_out.tif -o Dxcv constant_dx_out.tif test_hermite_dv_df_v| grep "Run  :"`

printf "Batched time: "
printf "$con_cmd \n"

set con_cmd_ref=`testshade -g 1024 1024 -t 1 --iters $ITER_NUM --stats -od uint8 -o cv constant_ref.tif -o Dxcv constant_dx_ref.tif test_hermite_dv_df_v| grep "Run  :"`
