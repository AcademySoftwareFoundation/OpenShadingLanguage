...
namespace {
template<> struct BatchedCGPolicy<Param::WF, Param::WF, Param::WF> {
    static constexpr int simd_threshold = 4;
};
template<> struct BatchedCGPolicy<Param::WF, Param::WV> {
    static constexpr int simd_threshold = 4;
};
template<> struct BatchedCGPolicy<Param::WF, Param::WV, Param::WF> {
