...
\date{{\large Date: 5 November, 2009 \\
...
Like all \colorclosure's, the return ``value'' is symbolic and is may be
...
is.  The {\cf R0} parameter supplies the reflectance fraction at normal
(perpendicular to the surface) incidence.
...
\apiitem{\colorclosure\ {\ce reflection} (normal N, \pl) \\
\colorclosure\ {\ce reflection} (normal N, float R0, \pl)}
\indexapi{reflection()}
...
If the optional {\cf R0} parameter is supplied, it is the reflectance
fraction at normal (perpendicular to the surface) incidence and is used
to compute the reflectance amount at other angles according to Shlick's
approximation.
