...
`int` **`substr`** `(string str, output string results[], string sep, int maxsplit)` <br> `int` **`substr`** `(string str, output string results[], string sep)` <br> `int` **`substr`** `(string str, output string results[])`
