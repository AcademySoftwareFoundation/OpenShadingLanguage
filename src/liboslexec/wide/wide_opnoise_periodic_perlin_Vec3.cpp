...
namespace {
template<>
struct BatchedCGPolicy<Param::WV, Param::WF, Param::WF, Param::WF, Param::WF> {
    static constexpr int simd_threshold = 4;
};
template<> struct BatchedCGPolicy<Param::WV, Param::WV, Param::WV> {
    static constexpr int simd_threshold = 4;
};
template<>
struct BatchedCGPolicy<Param::WV, Param::WV, Param::WF, Param::WV, Param::WF> {
