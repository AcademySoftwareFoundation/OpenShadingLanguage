...
echo testshade -t 1 -g 64 64 -param fromspace $1 -param tospace $2 -od uint8 -o Cout "sout_transform_$1_fromspace_$2_tospace_v_point.tif" test_transform_u_fromspace_u_tospace_v_point
...
echo testshade -t 1 --batched -g 64 64 -param fromspace $1 -param tospace $2 -od uint8 -o Cout "bout_transform_$1_fromspace_$2_tospace_v_point.tif" test_transform_u_fromspace_u_tospace_v_point
...
echo testshade --vary_udxdy --vary_vdxdy -t 1 -g 64 64 -param fromspace $1 -param tospace $2 -od uint8 -o Cout "sout_transform_$1_fromspace_$2_tospace_v_dpoint.tif" test_transform_u_fromspace_u_tospace_v_dpoint
...
echo testshade --vary_udxdy --vary_vdxdy -t 1 --batched -g 64 64 -param fromspace $1 -param tospace $2 -od uint8 -o Cout "bout_transform_$1_fromspace_$2_tospace_v_dpoint.tif" test_transform_u_fromspace_u_tospace_v_dpoint
