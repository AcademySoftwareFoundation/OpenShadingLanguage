...
\date{{\large Date: 16 November, 2009 \\
...
int {\ce getattribute} (string name, int arrayindex, output \emph{type} destination)}
...
The second form of this function, with the {\cf arrayindex} parameter,
retrieves the individual indexed element of the named array.  In this
