...
oslc test_atan2_w16dfw16dfw16df.osl  
oslc test_atan2_w16dvw16dvw16v.osl
oslc test_atan2_w16dfw16dfw16f.osl   
oslc test_atan2_w16dvw16vw16dv.osl
oslc test_atan2_w16dfw16fw16df.osl   
oslc test_atan2_w16fw16fw16f.osl
oslc test_atan2_w16dvw16dvw16dv.osl  
oslc test_atan2_w16vw16vw16v.osl
oslc test_atan2_w16f_f_f.osl

echo "\n"
echo "*******************"
echo "osl_atan2_w16f_f_f"
echo "*******************"

testshade  --batched -g 200 200 test_atan2_w16f_f_f \
                        -od uint8 -o res wfff_out.tif -o res_m m_wfff_out.tif 
testshade -g 200 200 test_atan2_w16f_f_f \
                      -od uint8 -o res wfff_ref.tif -o res_m m_wfff_ref.tif
...
testshade --batched  -g 200 200 test_atan2_w16f_w16f_w16f  -od uint8 -o res wfwfwf_out.tif -o res_m m_wfwfwf_out.tif
testshade -g 200 200 test_atan2_w16f_w16f_w16f -od uint8 -o res wfwfwf_ref.tif -o res_m m_wfwfwf_ref.tif
...
testshade --batched  -g 200 200 test_atan2_w16df_w16df_w16df -od uint8 -o res wdfwdfwdf_out.tif \
                                                                                      -o Dxres wdfwdfwdf_dx_out.tif \
                                                                                      -o res_m m_wdfwdfwdf_out.tif\
                                                                                      -o Dxres_m m_wdfwdfwdf_dx_out.tif
                                                                                      
testshade  -g 200 200 test_atan2_w16df_w16df_w16df -od uint8 -o res wdfwdfwdf_ref.tif \
...
testshade --batched  -g 200 200 test_atan2_w16df_w16df_w16f -od uint8 -o res wdfwdfwf_out.tif \
                                                                                      -o Dxres wdfwdfwf_dx_out.tif \
                                                                                      -o res_m m_wdfwdfwf_out.tif\
                                                                                      -o Dxres_m m_wdfwdfwf_dx_out.tif
                                                                                      
testshade  -g 200 200 test_atan2_w16df_w16df_w16f -od uint8 -o res wdfwdfwf_ref.tif \
...
testshade --batched  -g 200 200 test_atan2_w16df_w16f_w16df -od uint8 -o res wdfwfwdf_out.tif \
                                                                                      -o Dxres wdfwfwdf_dx_out.tif \
                                                                                      -o res_m m_wdfwfwdf_out.tif\
                                                                                      -o Dxres_m m_wdfwfwdf_dx_out.tif
                                                                                      
testshade  -g 200 200 test_atan2_w16df_w16f_w16df -od uint8 -o res wdfwfwdf_ref.tif \
...
testshade --batched  -g 200 200 test_atan2_w16dv_w16dv_w16dv -od uint8 -o res wdvwdvwdv_out.tif \
                                                                                      -o Dxres wdvwdvwdv_dx_out.tif \
                                                                                      -o res_m m_wdvwdvwdv_out.tif\
                                                                                      -o Dxres_m m_wdvwdvwdv_dx_out.tif
                                                                                      
testshade  -g 200 200 test_atan2_w16dv_w16dv_w16dv -od uint8 -o res wdvwdvwdv_ref.tif \
...
testshade --batched  -g 200 200 test_atan2_w16dv_w16dv_w16v -od uint8 -o res wdvwdvwv_out.tif \
                                                                                      -o Dxres wdvwdvwv_dx_out.tif \
                                                                                      -o res_m m_wdvwdvwv_out.tif\
                                                                                      -o Dxres_m m_wdvwdvwv_dx_out.tif
                                                                                      
testshade  -g 200 200 test_atan2_w16dv_w16dv_w16v -od uint8 -o res wdvwdvwv_ref.tif \
...
testshade --batched  -g 200 200 test_atan2_w16dv_w16v_w16dv -od uint8 -o res wdvwvwdv_out.tif \
                                                                                      -o Dxres wdvwvwdv_dx_out.tif \
                                                                                      -o res_m m_wdvwvwdv_out.tif\
                                                                                      -o Dxres_m m_wdvwvwdv_dx_out.tif
                                                                                      
testshade  -g 200 200 test_atan2_w16dv_w16v_w16dv -od uint8 -o res wdvwvwdv_ref.tif \
...
testshade --batched  -g 200 200 test_atan2_w16v_w16v_w16v  -od uint8 -o res wvwvwv_out.tif -o res_m m_wvwvwv_out.tif
testshade -g 200 200 test_atan2_w16v_w16v_w16v -od uint8 -o res wvwvwv_ref.tif -o res_m m_wvwvwv_ref.tif
