...
echo testshade -t 1 -g 64 64 -param tospace $1 -od uint8 -o Cout "sout_transform_$1_tospace_v_vector.tif" test_transform_u_tospace_v_vector
...
echo testshade -t 1 --batched -g 64 64 -param tospace $1 -od uint8 -o Cout "bout_transform_$1_tospace_v_vector.tif" test_transform_u_tospace_v_vector
...
echo testshade --vary_udxdy --vary_vdxdy -t 1 -g 64 64 -param tospace $1 -od uint8 -o Cout "sout_transform_$1_tospace_v_dvector.tif" test_transform_u_tospace_v_dvector
...
echo testshade --vary_udxdy --vary_vdxdy -t 1 --batched -g 64 64 -param tospace $1 -od uint8 -o Cout "bout_transform_$1_tospace_v_dvector.tif" test_transform_u_tospace_v_dvector
